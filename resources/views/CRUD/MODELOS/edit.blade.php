        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="bg-primary text-white px-6 py-4 flex items-center">
                    ...
                    <h2 class="text-xl font-bold">Editar Modelo</h2>
                </div>
                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('modelos.update', $modelo) }}" method="POST" id="modeloForm" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="relative">
                                ...
                                >{{ old('descripcion', $modelo->descripcion) }}</textarea>
                            </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg mt-2">
                            ...
                            <p class="text-sm text-gray-600 mt-1">
                                Este modelo tiene <span class="font-medium">{{ $modelo->articulos_count ?? 0 }}</span> artículos asociados.
                            </p>
                        </div>
