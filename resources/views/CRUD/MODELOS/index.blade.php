...
<head>
    ...
    <title>Lista de Modelos | AMI</title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="bg-primary text-white py-6">
        <div class="container mx-auto px-4">
            <h1 class="text-3xl font-bold">Gestión de Modelos</h1>
            <p class="mt-2">Administra los modelos disponibles en el inventario</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="flex items-center">
                    ...
                    <h2 class="text-2xl font-bold text-primary">Lista de Modelos</h2>
                </div>
                <div class="flex items-center gap-4 w-full md:w-auto">
                    ...
                    <a href="{{ route('modelos.create') }}" class="bg-accent hover:bg-green-600 text-white font-medium py-2 px-4 rounded-lg transition flex items-center whitespace-nowrap">
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-collapse" id="modelosTable">
                    <thead>
                        <tr class="bg-gray-50 text-gray-700 text-sm uppercase tracking-wider">
                            ...
                            <th class="px-6 py-3 text-left cursor-pointer hover:text-accent" onclick="sortTable(3)">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t border-gray-200 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">{{ $modelo->descripcion }}</td>
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center items-center space-x-2">
                                    <a href="{{ route('modelos.edit', $modelo) }}" class="bg-blue-500 hover:bg-blue-600 text-white p-2 rounded transition">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button 
                                        type="button" 
                                        onclick="showDeleteModal({{ $modelo->id }}, '{{ $modelo->nombre }}')" 
            ...
            <div class="text-center py-16">
                ...
                <h3 class="text-xl font-medium text-gray-600">No hay modelos registrados</h3>
                <p class="text-gray-500 mt-2">Comienza agregando un nuevo modelo para gestionar tu inventario</p>
                <a href="{{ route('modelos.create') }}" class="mt-4 inline-block bg-accent hover:bg-green-600 text-white font-medium py-2 px-6 rounded-lg transition">
                    <i class="fas fa-plus mr-2"></i> Agregar modelo
                </a>
            </div>
            @endif
            ...
            <div class="border-t border-gray-200 px-6 py-4 flex items-center justify-between">
                <div class="text-sm text-gray-600">
                    Mostrando <span class="font-medium">{{ count($modelos) }}</span> modelos
                </div>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center">
        <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md mx-4">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-600 mt-2">¿Estás seguro que deseas eliminar el modelo <strong id="modeloName"></strong>? Esta acción no se puede deshacer.</p>
            </div>
    ...
    <script>
        ...
        function showDeleteModal(id, name) {
            ...
            document.getElementById('modeloName').textContent = name;
            document.getElementById('deleteForm').action = `/modelos/${id}`;
        }
        ...
        document.getElementById('searchInput').addEventListener('keyup', function() {
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                if (nombre.includes(searchValue) || descripcion.includes(searchValue) || marca.includes(searchValue)) {
